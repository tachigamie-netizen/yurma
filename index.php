...
<section class="section room">
    <div class="container">
       ...
       <div class="tours_header">
            ...
            <p class="tours_text">Наша база расположена в живописном уголке — место тихое, кругом лес. Есть как комфортные и просторные варианты, так и варианты попроще и подешевле. После насыщенного дня приятно вернуться в уютное место и отдохнуть.</p>
        </div>
        <div class="card-grid">
            <?php
