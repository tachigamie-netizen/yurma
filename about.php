    ...
    <section class="section about">
        <div class="container">
            ...
            <div class="about-grid">
                ...
                <h3>❄️☀️ Летом и зимой</h3>
                <p>Квадроциклы и снегоходы в идеальном состоянии. Техника для любого сезона.</p>
                <h3>📍 Сердце Южного Урала</h3>
                <p>Клуб расположен у подножия хребта Юрма — там, где начинаются настоящие приключения.</p>
                <h3>🏔️ Природа 360°</h3>
                <p>Леса, горы, кристально чистые озёра и горные реки. Маршруты на любой сезон.</p>
                <h3>🛡️ Опытные гиды</h3>
                <p>Каждый маршрут сопровождает гид, который обеспечит безопасность и покажет самые красивые места.</p>
                <h3>⭐ Признание</h3>
                <p>В 2017 году у нас отдыхал победитель Dakar Сергей Карякин. Но главное — тысячи гостей, которые возвращаются снова.</p>
                </div>
